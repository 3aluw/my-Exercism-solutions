...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for category in categories: 
        if(category[1].issuperset(dish_ingredients)):
                dish_category = category[0]
                break
...
def compile_ingredients(dishes):
    ...
    """
    all_ingredients = []
    for dish_ingeredients in dishes:
        all_ingredients += dish_ingeredients
...
def separate_appetizers(dishes, appetizers):
    ...
    for appetizer in appetizers:
        if(appetizer in dishes):
           dishes.remove(appetizer)
...
def singleton_ingredients(dishes, intersection):
    ...
    for dish in dishes:
        intersection_set |= (dish - intersection)
